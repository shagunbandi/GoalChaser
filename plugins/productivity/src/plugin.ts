...
import type { Plugin, PluginAISchema, AIWizardFlowProps, PluginQuickStats, PluginPeriodInsights } from '@goal-chaser/sdk'
import { getScoreBackgroundColor } from './utils/score-utils'
...
export const ProductivityPlugin: Plugin<ProductivityDayData, ProductivityConfig> = {
  ...
  calendar: {
    getCalendarBackground: (data) => {
      ...
      const color = getScoreBackgroundColor(data.status)
