...
import type { ExecutiveGoalFile } from '../types'
...
interface FileUploadProps {
  ...
  onFilesChange: (files: ExecutiveGoalFile[]) => Promise<void>
}
...
export function FileUpload({
  ...
  const handleOpenFile = async (file: ExecutiveGoalFile) => {
  ...
  const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      formData.append('executiveGoalId', executiveGoalId)
  ...
  const handleDelete = async (file: ExecutiveGoalFile) => {
    try {
